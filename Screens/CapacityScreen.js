                    ...
                    >
                        <View style={{ flexDirection: 'row' }}>
                            <View style={{ alignItems: 'center', marginRight: 20 }}>
                                <View style={{ width: 20, height: 20, backgroundColor: "#35b24c", borderRadius: 5, justifyContent: 'space-between' }} />
                                <Text>Free</Text>
                            </View>
                            <View style={{ alignItems: 'center', marginRight: 20 }}>
                                <View style={{ width: 20, height: 20, backgroundColor: "#3063ed", borderRadius: 5, justifyContent: 'space-between' }} />
                                <Text>Male</Text>
                            </View>
                            <View style={{ alignItems: 'center', marginRight: 20 }}>
                                <View style={{ width: 20, height: 20, backgroundColor: "#fb607f", borderRadius: 5, justifyContent: 'space-between' }} />
                                <Text>Female</Text>
                            </View>
                            <View style={{ alignItems: 'center', marginRight: 20 }}>
                                <View style={{ width: 20, height: 20, backgroundColor: "#f5bc42", borderRadius: 5, justifyContent: 'space-between' }} />
                                <Text>My seat</Text>
                            </View>
